...
using static TAPTAGPOS.Caisse;

namespace TAPTAGPOS
{
    public partial class CaisseCafe : Form
    {
        ...
        public CaisseCafe(int ticketIdToLoad = 0)
        {
            InitializeComponent();
            // In your form's designer file (e.g., CaisseCafe.Designer.cs)
            // This code is typically auto-generated by the WinForms designer.
            // This code goes inside the InitializeComponent() method in the CaisseCafe.Designer.cs file.
            ...
            this.bunifuButton216.Click += new System.EventHandler(this.bunifuButton216_Click); // Opens keyboard for search
            this.txtSearch.TextChanged += new System.EventHandler(this.txtSearch_TextChanged);

            // Left-Side Action Panel
            this.btn_Valider.Click += new System.EventHandler(this.btn_Valider_Click);                  // Confirms and saves the sale
            this.btn_customer.Click += new System.EventHandler(this.btn_customer_Click);                // Opens customer selection form
            this.btn_quantitymoin1.Click += new System.EventHandler(this.bunifuIconButton1_Click);      // Decrements selected item quantity
            this.btn_QuantityPlus1.Click += new System.EventHandler(this.bunifuIconButton2_Click);      // Increments selected item quantity
            this.btn_Quantity.Click += new System.EventHandler(this.btn_Quantity_Click);                // Opens form to set a specific quantity
            this.Btn_PriceChange.Click += new System.EventHandler(this.bunifuButton24_Click);           // Opens form to change item price
            this.Btn_TarifsChange.Click += new System.EventHandler(this.Btn_TarifsChange_Click);         // Opens form to change the price tier
            this.btn_warehousepick.Click += new System.EventHandler(this.btn_warehousepick_Click);      // Opens form to select a warehouse
            this.ListTickets.Click += new System.EventHandler(this.ListTickets_Click);                  // Opens the list of past transactions
            this.bunifuButton28.Click += new System.EventHandler(this.btn_delete_item_Click);           // Deletes the selected item from the cart
            this.bunifuButton29.Click += new System.EventHandler(this.bunifuButton29_Click);             // Cancels the entire invoice
            this.btn_addtoattente.Click += new System.EventHandler(this.btn_addtoattente_Click);          // Puts the current sale on hold
            this.btn_listeAttente.Click += new System.EventHandler(this.bunifuButton211_Click);          // Opens the list of held sales
            this.bunifuButton212.Click += new System.EventHandler(this.bunifuButton212_Click);           // Marks a selected item for return
            this.btn_freequantity.Click += new System.EventHandler(this.btn_freequantity_Click);        // Adds the selected item as a free item
            this.btn_Remise.Click += new System.EventHandler(this.btn_Remise_Click);                    // Applies a discount
            this.bunifuButton215.Click += new System.EventHandler(this.bunifuButton215_Click);           // Exits the form

            // Article Display Panel
            this.BtnPrevious.Click += new System.EventHandler(this.BtnPrevious_Click);                  // Navigates to the previous page of articles
            this.BtnNext.Click += new System.EventHandler(this.BtnNext_Click);                          // Navigates to the next page of articles

            // Payment Panel
            this.btn_cash.Click += new System.EventHandler(this.btn_cash_Click);                        // Opens cash payment form
            this.btn_cartebancaire.Click += new System.EventHandler(this.btn_cartebancaire_Click);      // Opens card payment form
            this.btn_Credit.Click += new System.EventHandler(this.btn_Credit_Click);                    // Processes the sale as credit
            this.btn_cheque.Click += new System.EventHandler(this.btn_cheque_Click);                    // Opens cheque payment form
            this.btn_cancelpaiment.Click += new System.EventHandler(this.btn_cancelpaiment_Click);      // Cancels all payments made in the current session

            // DataGridView Events
            this.DatagridArticles.CurrentCellDirtyStateChanged += new System.EventHandler(this.DatagridArticles_CurrentCellDirtyStateChanged);
            this.DatagridArticles.CellValueChanged += new System.Windows.Forms.DataGridViewCellEventHandler(this.DatagridArticles_CellValueChanged);            // Dynamically Assigned Events (in CaisseCafe.cs, not the designer)
            // These are assigned in code, not in the designer file.
            // Example from your code:
            // In DisplayCategories():
        ...
        public List<Article> GetArticles(int offset, int limit, int warehouseId)
        {
            ...
            if (warehouseId == 0) // A warehouse ID of 0 means "All Warehouses"
            {
                ...
                query = @"
            SELECT Id, Article, ArticleLongName,BuyPrice, Barcodes, DetailsPrice, SemigrosPrice, GrosPrice, SpecialPrice, QuantityStock, ArticleColor ,ImagePath
            ...
            SELECT 
                ...
                a.SemigrosPrice, a.GrosPrice, a.SpecialPrice, a.ArticleColor,a.ImagePath
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Article article = new Article
                        {
                            ...
                            ImagePath = reader["ImagePath"] as string ?? string.Empty // Safely read the path
        ...
        private void DisplayArticles()
        {
            ...
            {
                var articleControl = new ArticleControlCafe();
    ...
    OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY";
        ...
        private void ListTickets_Click(object sender, EventArgs e)
        {
            using (LISTTICKET attForm = new LISTTICKET())
            {
                ...
                attForm.ParentCaisseForm2 = this;
